...
//            $wallet = wallet::where('username', $user->username)->first();
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_POSTFIELDS => array('account_name' => $user->username, 'business_short_name' => 'BORIS', 'uniqueid' => $user->name, 'email' => $user->email, 'phone' => $user->phone, 'webhook_url' => 'https://app.borismobilemoney.com.ng/api/run',),
