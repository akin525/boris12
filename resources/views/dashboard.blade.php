...
{{--                        </svg>--}}
                        <h2 class="text-black mb-2 font-w600">₦{{number_format(intval( Auth::user()->wallet *1),2)}}</h2>
                        <p class="mb-0 fs-14">
...
{{--                                </defs>--}}
{{--                            </svg>--}}
                            <span class="text-success mr-1"></span>Wallet Balance
                        </p>
                    </div>
                </div>
            </div>
...
{{--                        </svg>--}}
                        <h2 class="text-black mb-2 font-w600">₦{{number_format(intval($totaldeposite *1),2)}}</h2>
                        <p class="mb-0 fs-13">
{{--                            <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
...
{{--                                </defs>--}}
{{--                            </svg>--}}
                            <span class="text-success mr-1"></span>Total Deposit
                        </p>
                    </div>
                </div>
            </div>
...
{{--                        </svg>--}}
                        <h2 class="text-black mb-2 font-w600">₦{{number_format(intval($bill *1),2)}}</h2>
                        <p class="mb-0 fs-14">
{{--                            <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
...
{{--                                </defs>--}}
{{--                            </svg>--}}
                            <span class="text-danger mr-1"></span>Total Bills
                        </p>
                    </div>
                </div>
            </div>
